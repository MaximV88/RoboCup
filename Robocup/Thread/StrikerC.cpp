...
void StrikerC::actPlayMode(PlayMode ePlayMode) {
...
StrikerC::StrikerC(const Connection* cConnection, const char* chTeamName) :
Player(cConnection, chTeamName, false) {
    ...
    cMoveStart->addChild(new SetTargetToNode(new BehaviorTarget(Coordinate(-10, 10), "Striker")));
