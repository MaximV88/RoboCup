...
void StrikerA::actPlayMode(PlayMode ePlayMode) {
...
StrikerA::StrikerA(const Connection* cConnection, const char* chTeamName) :
Player(cConnection, chTeamName, false) {
    ...
    cMoveStart->addChild(new SetTargetToNode(new BehaviorTarget(Coordinate(-5, -10), "Striker")));
